        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mt-4 text-sm">
              Connect with friends, share your moments, and explore the world through Nebula - your next-generation social media platform.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/about" className="hover:text-purple-400 text-sm">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/privacy" className="hover:text-purple-400 text-sm">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/terms" className="hover:text-purple-400 text-sm">
                  Terms of Service
                </Link>
              </li>
              <li>
                <Link href="/contact" className="hover:text-purple-400 text-sm">
                  Contact Us
                </Link>
              </li>
            </ul>
